...
<a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
    <img src="{{ asset('img/images.jpeg') }}" class="user-image img-circle elevation-2" alt="User Image">
    <span class="d-none d-md-inline">Bagus Aufa Ariq</span>
</a>
<ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
    <!-- User image -->
        <li class="user-header bg-primary">
        <img src="{{ asset('img/images.jpeg') }}" class="img-circle elevation-2" alt="User Image">

        <p>
            Bagus Aufa Ariq - Mahasiswa
